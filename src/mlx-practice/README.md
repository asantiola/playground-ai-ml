...
- to pull:
```
docker model pull hf.co/mlx-community/gemma-4-e4b-it-4bit
docker model pull hf.co/mlx-community/Meta-Llama-3.1-8B-Instruct-4bit
```
- config
```
llm = ChatOpenAI(
...
```
- output for huggingface.co/mlx-community/gemma-4-e4b-it-4bit
```
...
```
- output for huggingface.co/mlx-community/Meta-Llama-3.1-8B-Instruct-4bit
```
openai.InternalServerError: unable to load runner: error waiting for runner to be ready: vllm-metal terminated unexpectedly: vllm-metal failed: uper().__init__(
(APIServer pid=91577)   File "/Users/asantiola/.docker/model-runner/vllm-metal/lib/python3.12/site-packages/vllm/v1/engine/core_client.py", line 535, in __init__
(APIServer pid=91577)     with launch_core_engines(
(APIServer pid=91577)          ^^^^^^^^^^^^^^^^^^^^
(APIServer pid=91577)   File "/Users/asantiola/.docker/model-runner/vllm-metal/lib/python3.12/contextlib.py", line 144, in __exit__
(APIServer pid=91577)     next(self.gen)
(APIServer pid=91577)   File "/Users/asantiola/.docker/model-runner/vllm-metal/lib/python3.12/site-packages/vllm/v1/engine/utils.py", line 998, in launch_core_engines
(APIServer pid=91577)     wait_for_engine_startup(
(APIServer pid=91577)   File "/Users/asantiola/.docker/model-runner/vllm-metal/lib/python3.12/site-packages/vllm/v1/engine/utils.py", line 1057, in wait_for_engine_startup
(APIServer pid=91577)     raise RuntimeError(
(APIServer pid=91577) RuntimeError: Engine core initialization failed. See root cause above. Failed core proc(s): {'EngineCore': 1}
```
