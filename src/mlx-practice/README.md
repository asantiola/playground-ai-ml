...
python -m mlx_lm.generate --model mlx-community/phi-4-6bit --prompt "What is the capital of France?"
python -m mlx_vlm.generate --model mlx-community/gemma-4-12B-it-6bit --prompt "What is the capital of France?"
```
