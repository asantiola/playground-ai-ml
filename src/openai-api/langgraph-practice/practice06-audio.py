...
path_brown_fox = os.path.join(workspaces, "playground-ai-ml/shared-data/python/audios/brown_fox.wav")
path_itik = os.path.join(workspaces, "playground-ai-ml/shared-data/python/audios/itik.mp3")
path_puzzle = os.path.join(workspaces, "playground-ai-ml/shared-data/python/audios/puzzle.mp3")
