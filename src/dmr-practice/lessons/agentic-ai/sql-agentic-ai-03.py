...
# OOP approach 2 of sql-agentic-ai-01.py
...
try:
    ...
    agent_expert("Who is the employee with the highest salary, and how much was the salary?")
    agent_expert("Who are the top three highest earning employees, and what are their salaries?")
    agent_expert("What is the largest bone in the human body?")
    agent_expert("Which department has the most number of employees, and how many employees does it have?")
    agent_expert("Among the employees with contact information, who has the highest salary and what is the email address?.")
    agent_expert("How many moons does Jupiter have?")
